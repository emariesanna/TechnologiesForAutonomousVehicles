...
from spconv.pytorch import SparseConv3d, SubMConv3d, SparseConvTensor, SparseSequential, SparseBatchNorm
...
class CenterNet3D(nn.Module):
    def __init__(self, sparse_shape, heads, head_conv, num_input_features=4, bias=False):
        ...
        self.net3d = SparseSequential(
            SubMConv3d(num_input_features, 16, 3, 1, 1, bias=bias),
            SparseBatchNorm(16),
            SparseLeakyReLU(inplace=True),
            SubMConv3d(16, 16, 3, 1, 1, bias=bias),
            SparseBatchNorm(16),
            SparseLeakyReLU(inplace=True),
            SparseConv3d(16, 32, 3, 2, 1, bias=bias),
            SparseBatchNorm(32),
            SparseLeakyReLU(inplace=True),

            SubMConv3d(32, 32, 3, 1, 1, bias=bias),
            SparseBatchNorm(32),
            SparseLeakyReLU(inplace=True),
            SubMConv3d(32, 32, 3, 1, 1, bias=bias),
            SparseBatchNorm(32),
            SparseLeakyReLU(inplace=True),
            SparseConv3d(32, 64, 3, 2, 1, bias=bias),
            SparseBatchNorm(64),
            SparseLeakyReLU(inplace=True),

            SubMConv3d(64, 64, 3, 1, 1, bias=bias),
            SparseBatchNorm(64),
            SparseLeakyReLU(inplace=True),
            SubMConv3d(64, 64, 3, 1, 1, bias=bias),
            SparseBatchNorm(64),
            ...
            SparseBatchNorm(64),
            SparseLeakyReLU(inplace=True),
            SparseConv3d(64, 64, 3, 2, 1, bias=bias),
            SparseBatchNorm(64),
            SparseLeakyReLU(inplace=True),
            SubMConv3d(64, 64, 3, 1, 1, bias=bias),
            SparseBatchNorm(64),
    ...
    def forward(self, voxel_features, coors, batch_size):
        ...
        coors = coors.int()
        feat_voxelization = SparseConvTensor(voxel_features, coors, self.sparse_shape, batch_size)
        print("feat_voxelization:", feat_voxelization)
